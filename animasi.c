...
// print to file (tambah barang) function
// Fungsi untuk menambahkan data barang ke file "barang.txt".
// void tambah_barang(char id[], char nama[], int stock, float harga, char *win_linux)
// {
//     FILE *output_fp;

//     output_fp = fopen("barang.txt", "a");
//     if (output_fp == NULL) {
//         printf("\033[31mGagal membuka file 'barang.txt'.\033[0m\n");
//         return;
//     }

//     fprintf(output_fp, "\n%s \"%[^\"]\" %d %f", id, nama, stock, harga);

//     fclose(output_fp);

//     printf("\033[33m Barang berhasil ditambahkan!\033[0m\n");
//     enter(2);
//     hyphen("\033[1;33m", 130, 10, "TRUE");

//     // Tambahkan kode berikut agar program tidak langsung keluar
